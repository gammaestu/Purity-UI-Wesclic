...
@section('content')
    <div class="w-full max-w-md">
        <h1 class="text-4xl font-semibold text-emerald-400 mb-2">Welcome Back</h1>
        ...
        <form action="#" method="post" class="space-y-5">
            ...
            <div class="flex items-center gap-3 pt-1">
                <button type="button" class="relative inline-flex h-5 w-10 items-center rounded-full bg-emerald-400">
            ...
            <button type="button" class="w-full rounded-xl bg-emerald-400 text-white text-xs font-semibold py-3 hover:bg-emerald-500">
                SIGN IN
            </button>

            <p class="text-center text-[11px] text-slate-400 pt-1">
                Don't have an account?
                <a href="{{ route('auth.signup') }}" class="text-emerald-400 font-semibold hover:text-emerald-500">Sign up</a>
            </p>
        </form>
    </div>
@endsection

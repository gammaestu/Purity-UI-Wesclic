                ...
                <tr class="border-b border-slate-50 last:border-0">
                    <td class="py-4">
                        <div class="flex items-center gap-3">
                            ...
                            >
                            <div>
                                <p class="font-semibold text-slate-700 leading-tight">{{ $row['name'] }}</p>
                                <p class="text-[11px] text-slate-400">{{ $row['email'] }}</p>
                            </div>
                        </div>
                    </td>
                    <td class="py-4">
                        <p class="font-semibold text-slate-700 leading-tight">{{ $row['role'] }}</p>
                        <p class="text-[11px] text-slate-400">{{ $row['dept'] }}</p>
                    </td>
                    <td class="py-4">
                        @php
                            $online = strtolower($row['status']) === 'online';
